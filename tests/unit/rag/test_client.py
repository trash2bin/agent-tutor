...
async def test_client_list_documents(rag_client):
    ...
    route = respx.post("http://test-rag:8082/documents/list").mock(
        return_value=Response(
            200,
            json={
                "documents": [{"id": "doc1", "title": "T1", "source_path": "p1", "mime_type": "txt", "discipline_id": "d1", "created_at": "now"}],
                "count": 1
            }
        )
    )
        ...
        return_value=Response(
            ...
            json={
                "results": [{
                    ...
                    "page": 1, "score": 0.9, "content": "Hello world"
                }],
                "count": 1
            }
        )
                ...
                "chunks": [
                    {
                        "document_id": "doc1", "document_title": "T1", "source_path": "p1",
                        "discipline_id": "d1", "chunk_id": "c1", "chunk_index": 0,
                        "page": 1, "score": 0.9, "content": "Some content"
                    }
                ]
            }
        )
